...
![[../assets/Pasted image 20260617221651.png]]
- `[노란색 캡슐`] : 캐릭터 CCT
- `[초록색 캡슐`] : 몬스터 CCT
- `[빨간색 바닥]`: 지형 Static 메쉬

![[../assets/Pasted image 20260617222113.png]]
- `[노란색 직육면체]`: 캐릭터의 상호작용 감지 TriggerBox

![[../assets/Pasted image 20260617222217.png]]
- `[노란색 구]`: 캐릭터의 몬스터 감지 Trigger Sphere (미니맵에서 사용)

![[../assets/Pasted image 20260617223702.png]]
- `[검은색 구 와이어프레임]`: 공격용 Overlap (Scene Query)
- `[작은 초록색 알갱이]`: 래그돌 (Hit 판정으로 래그돌 상태 돌입)

![[../assets/Pasted image 20260617225026.png]]
![[../assets/Pasted image 20260617225057.png]]
- PhysX 루프 중 물리 레이어와 마스크를 비교해 충돌 대상 선별 (FilterShader)

![[../assets/Pasted image 20260617230114.png]]
- 선별된 충돌 이벤트를 OnCollisionEnter, OnCollision, OnCollisionExit 형태로 게임 오브젝트에 전달

![[../assets/Pasted image 20260617230236.png]]
- 공격용 Overlap 충돌 이벤트를 데미지, 공격자 정보와 함께 게임 오브젝트로 넘겨주는 부분

![[../assets/Pasted image 20260617230347.png]]
...
![[../assets/Pasted image 20260617233821.png]]
- 피격당한 몬스터 CCT 캡슐은 비활성화 되고 래그돌이 배치된다

![[../assets/Pasted image 20260617234224.png]]
![[../assets/Pasted image 20260617234241.png]]
